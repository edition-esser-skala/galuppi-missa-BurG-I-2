...
QuoniamOrgano = {
  \relative c {
    ...
    \partial 8*5 r8 \mvTr a\p-\soloE r d r %415
    e c' h a d c h a
    d c h a d c h a
    e' e, r4 r gis8 a
    e' e, r4 r gis8 a
...
QuoniamBassFigures = \figuremode {
  ...
  <_+>
  <6>4 <5 [_+]> <[5+] _+> <6>8 <6+ 5>
  \bo <[6 4]>4 \bc <[5+ _+]> r <6>8 <6+ 5> %455
  \bo <[6 4]>4 \bc <[5+ _+]> r2 %456 finis
}
...
CumSanctoBassFigures = \figuremode {
  ...
  <5 3> <6 4>
  r1
  \bo <[6 5]>2 <8 6>4 \bc <[7 5]> %470
  <_+>2 <6 4>
  <[5] _+> <6 4>
  \bo <[_+]>2. \bc <[6]>4
  r2 <6 5>4 <6 5>8 <_+>
  r4 \bo <[6\\ \l]>4 <6>4. <6 5>8 %475
  r4 <6 4>8 <5 _+> r4 \bc <[6 \l]>
  r2 <7>
  <7 [5+]> <7>
  q <7 _+>
  ...
  q q
  <7 5 _+>1
  r4 \bo <[8 6 _+]>8 <7 5 \t> <_+> <6> r <6 5> %495
  <6 4>4 \bc <[5 _+ \l]> r2
  r1
  r4 \bo <[6]> <6> <7>8 q
  r2 <6>4 <7>8 q
